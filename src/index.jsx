...
function App() {
  ...
  return (
    <div style={{minHeight: '100vh'}}>
          ...
          {currentPage === 'home' && (
            <div>
              ...
              <div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px', marginTop: '20px'}}>
                <div className="card">
                  <h3 style={{fontSize: '18px', fontWeight: '600', marginBottom: '12px'}}>📝 To-Do List</h3>
                  <div style={{marginBottom: '8px'}}>• Sign permission slip</div>
                  <div style={{marginBottom: '8px'}}>• Pack lunch boxes</div>
                  <div>• Schedule dentist appointment</div>
                </div>
                
                <div className="card">
                  <h3 style={{fontSize: '18px', fontWeight: '600', marginBottom: '12px'}}>🛒 Shopping List</h3>
                  <div style={{marginBottom: '8px'}}>• Fruits and vegetables</div>
                  <div style={{marginBottom: '8px'}}>• School supplies</div>
                  <div>• Swimming gear</div>
                </div>
              </div>
            </div>
          )}
            ...
            <div>
              ...
              <div className="card">
                ...
                <div style={{marginTop: '16px'}}>
                  <button style={{background: '#2563eb', color: 'white', padding: '8px 12px', border: 'none', borderRadius: '4px', marginRight: '8px', cursor: 'pointer'}}>📅 Extraire événements</button>
                  <button style={{background: '#16a34a', color: 'white', padding: '8px 12px', border: 'none', borderRadius: '4px', cursor: 'pointer'}}>📤 Partager</button>
                </div>
              </div>
            </div>
          )}
      ...
      <button style={{position: 'fixed', bottom: '80px', right: '16px', width: '56px', height: '56px', borderRadius: '50%', background: '#1a7ba6', border: 'none', color: 'white', fontSize: '20px', cursor: 'pointer', boxShadow: '0 4px 12px rgba(0,0,0,0.15)'}} onClick={() => alert('Assistant vocal activé!')}>
        🎤
      </button>
    </div>
  );
